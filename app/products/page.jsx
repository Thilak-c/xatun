...
export default function CategoryPage() {
  ...
  return (
    <div className=" pt-[100px] md:pt-[50px] bg-gradient-to-b from-gray-900 to-black min-h-screen text-white p-0 md:p-12">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8">
          {category} Collection
        </h1>
        ...
        {filteredCategories.map(([category, types]) => (
          <section key={category} className="bg-transparent  min-h-screen relative md:mt-[0px] z-40">
